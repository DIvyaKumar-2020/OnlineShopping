...
import { MeatComponent } from 'app/entities/meat/meat.component';
import { MeatService } from 'app/entities/meat/meat.service';
import { Meat } from 'app/shared/model/meat.model';

describe('Component Tests', () => {
  describe('Meat Management Component', () => {
    let comp: MeatComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(MeatComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.meats && comp.meats[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
