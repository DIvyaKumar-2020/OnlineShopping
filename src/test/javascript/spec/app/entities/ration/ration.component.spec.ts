...
import { RationComponent } from 'app/entities/ration/ration.component';
import { RationService } from 'app/entities/ration/ration.service';
import { Ration } from 'app/shared/model/ration.model';

describe('Component Tests', () => {
  describe('Ration Management Component', () => {
    let comp: RationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.rations && comp.rations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
