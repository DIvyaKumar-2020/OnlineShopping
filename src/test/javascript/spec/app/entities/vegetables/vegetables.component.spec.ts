...
import { VegetablesComponent } from 'app/entities/vegetables/vegetables.component';
...
describe('Component Tests', () => {
  describe('Vegetables Management Component', () => {
    let comp: VegetablesComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VegetablesComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.vegetables && comp.vegetables[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
